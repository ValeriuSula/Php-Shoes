...
<header id="banner">
  <nav id="nav-main" role="navigation">
    <ul id="menu-primary-navigation" class="nav is-uppercase">
        <li class="menu-news"><a href="index1.html">Home</a></li>
        <li class="menu-tour"><a href="index1.html">Photos</a></li>
        <li class="menu-music"><a href="index1.html">About</a></li>
    </ul>  
    <a href="index1.html" style="position: absolute; right: 0; width: 4vw; margin-top: 2vh; color: white;"><i class="far fa-user"></i></a>  
  </nav>
</header>
</div>
...
<a href="index1.html"><div class="circle" style="background-image: url('shoe1.jpg');"><h1>Better</h1></div></a>

<a href="index1.html"><div class="circle" style="background-image: url('shoe2.jpg');"><h1>With</h1></div></a>

<a href="index1.html"><div class="circle" style="background-image: url('shoe3.jpg');"><h1>Us</h1></div></a>
